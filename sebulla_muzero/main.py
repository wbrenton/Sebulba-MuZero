...
def parse_args():
    ...
    parser.add_argument("--sequence-length", type=float, default=100,
...
if __name__ == "__main__":
    ...
    single_device_update = make_single_device_update(applys, optimizer, args, bias_plane_action_encoding_fn)
